...
// походу с роутерами всё ок. из сервера можно удалить старый код, errorHandler и validateBody мб исправить. а может не это, а только три кода, которые открыты сейчас